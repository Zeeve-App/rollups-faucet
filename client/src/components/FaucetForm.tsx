      ...
      <div className="box">
        ...
        <div className="box-content">
          {!txSuccessful ? (
              ...
              <div className="box-header">
                ...
                >
                  ...
                  <div className="beta-alert">
                    ...
                    <div>This is a testnet faucet. Funds are not real.</div>
                  </div>
            ...
            <TxSuccess
              msg={sendTokenResponse?.message}
              txHash={sendTokenResponse?.txHash}
              explorerUrl={chainConfigs[token!]?.EXPLORER}
              goBack={setTxSuccessful}
            />
          )}
        </div>
      </div>
